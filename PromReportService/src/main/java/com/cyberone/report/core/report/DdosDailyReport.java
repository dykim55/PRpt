...
public class DdosDailyReport extends BaseReport {
	...
	public DdosDailyReport(UserInfo userInfo) {
	...
	public HashMap<String, Object> getDataSource(String sReportType, String sSearchDate, HashMap<String, Object> hMap) throws Exception {
		logger.debug("DDoS 일일보고서 통계데이타 생성");
	...
	private void All_DetectLog_Trend(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			...
			dbResult = ddosDao.AllDetectLogTrend("HR", -1, assetCode, sStartDay, sEndDay);
			...
			dbResult = ddosDao.AllDetectLogTrend("DY", -1, assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
	...
	private void Direction_DetectLog_Trend(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			...
			Iterable<DBObject> dbResult = ddosDao.AllActionTrend("HR", nDirection, ALLOW, assetCode, sStartDay, sEndDay);
    		...
    		dbResult = ddosDao.AllActionTrend("HR", nDirection, "", assetCode, sStartDay, sEndDay);
			...
			Iterable<DBObject> dbResult = ddosDao.AllActionTrend("DY", nDirection, ALLOW, assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
	    	...
	    	String[] saGubun = {"차단", "허용"};
	    	for (int action = 0; action < 2; action++) { //아웃바운드/인바운드
	    		for (String tDay : dayPeriod) {
		    		HashMap<String, Object> map = new HashMap<String, Object>();
	    	...
	    	dbResult = ddosDao.AllActionTrend("DY", nDirection, "", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
	...
	private void Compare_DetectLog_Trend(HashMap<String, Object> reportData, int nDirection, String sAction, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			...
			Iterable<DBObject> dbResult = ddosDao.CompareDetectLogTrend("HR", nDirection, sAction, assetCode, sStartDay, sEndDay);
			...
			Iterable<DBObject> dbResult = ddosDao.CompareDetectLogTrend("DY", nDirection, sAction, assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
	...
	private void Direction_EventTopN(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay, int nLimit) throws Exception {
    	...
    	Iterable<DBObject> dbBefore = ddosDao.EventTopN("DY", nDirection, "", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), 0);
	...
	private void Direction_Action_EventTopN(HashMap<String, Object> reportData, int nDirection, String sAction, int assetCode, String sStartDay, String sEndDay, int nLimit, boolean bChk) throws Exception {
    	...
    	Iterable<DBObject> dbBefore = ddosDao.EventTopN("DY", nDirection, sAction, assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), 0);
    	HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>(); 
    	for (DBObject val : dbBefore) {
    		mapBefore.put((String)val.get("action") + "-" + (String)val.get("message"), val);
    	}
    	...
    	if (bChk) { //Event Top 발생추이
	    	...
	    	dbResult = ddosDao.EventTopNTrend("HR", nDirection, sAction, assetCode, sStartDay, sEndDay, saTopN);
	    	HashMap<String, DBObject> mapResult = new HashMap<String, DBObject>(); 
	    	for (DBObject val : dbResult) {
	    		String sMessage = (String)val.get("message");
	    		String sYear = ((Integer)val.get("year")).toString();
	...
	private void New_DetectLog_Condition(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay) throws Exception {
		...
		//전일 탐지 이벤트리스트
		Iterable<DBObject> dbResult = ddosDao.EventTopN("DY", nDirection, assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), null);
    	for (DBObject val : dbResult) {
		...
		for (DBObject mVal : newList) {
	    	...
	    	dbResult = ddosDao.EventTopNTrend("HR", nDirection, sAction, assetCode, sStartDay, sEndDay, sMessage);
	    	HashMap<String, DBObject> mapResult = new HashMap<String, DBObject>(); 
	...
	private void Double_DetectLog_Condition(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay) throws Exception {
		...
		//전일 탐지 이벤트리스트
		Iterable<DBObject> dbBefore = ddosDao.EventTopN("DY", nDirection, assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), null);
		HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>();
    	for (DBObject val : dbBefore) {
    		mapBefore.put((String)val.get("action") + "-" + (String)val.get("message"), val);
    	}
	...
	private void Action_DetectLog_TopN(HashMap<String, Object> reportData, int nDirection, String sAction, int assetCode, String sStartDay, String sEndDay, boolean bSrcIp, int nLimit, boolean bChk) throws Exception {
    	...
    	//전일 현황
    	Iterable<DBObject> dbBefore = ddosDao.BeforeIpCondition("DY", nDirection, sAction, assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), bSrcIp, topNIps);
    	HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>();
    	for (DBObject val : dbBefore) {
    		if (bSrcIp) {
    	...
    	if (bSrcIp) {
	    	...
	    	if (bChk) { //SRC IP TOP10 세션 로그 발생추이 
	        	...
	        	Iterable<DBObject> ipTopNTrend = ddosDao.IpTopNTrend("HR", nDirection, sAction, assetCode, sStartDay, sEndDay, topNIps, true);
	...
	private void ALL_ServiceTop10(HashMap<String, Object> reportData, int nDirection, int assetCode, String sStartDay, String sEndDay, boolean bChk) throws Exception {
    	...
    	if (bChk) { //서비스 TOP10 증감현황 및 이벤트유형
    		...
    		dbResult = ddosDao.ServiceDetectLog("DY", nDirection, assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), 0, false, 0);
        	HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>(); 
        	for (DBObject val : dbResult) {

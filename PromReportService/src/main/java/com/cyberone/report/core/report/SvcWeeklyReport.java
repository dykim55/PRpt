...
public class SvcWeeklyReport extends BaseReport {
		...
		for (Entry<String, Object> e : hData.entrySet()) {
			...
			switch (e.getKey()) {
				...
				case "opt08" : 
					...
					ServiceDeskStatItem08(reportData, cscoCd, sStartDay, sEndDay);
					break;
				case "opt09" : 
				...
				case "opt10" : 
					...
					ServiceDeskStatItem10(reportData, cscoCd, sStartDay, sEndDay, nChoice, !StringUtil.isEmpty(hData.get("ck10")));
					break;
				case "opt11" : 
	...
	private void ServiceDeskStatItem08(HashMap<String, Object> reportData, int cscoCd, String sStartDay, String sEndDay) throws Exception {
	...
	private void ServiceDeskStatItem10(HashMap<String, Object> reportData, int cscoCd, String sStartDay, String sEndDay, int nChoice, boolean bChk) throws Exception {

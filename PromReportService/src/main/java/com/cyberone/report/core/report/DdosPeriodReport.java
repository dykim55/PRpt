		...
		for (Entry<String, Object> e : hData.entrySet()) {
			...
			switch (e.getKey()) {
				...
				case "opt08" : case "opt09" : case "opt10" : case "opt11" : case "opt12" : case "opt13" :  
					...
					break;
				//출발지IP 현황
				case "opt14" : case "opt15" : case "opt16" : case "opt17" : case "opt18" : case "opt19" :  
					if (nC3 == 0) { 
					...
					break;
				//목적지IP 현황
				case "opt20" : case "opt21" : case "opt22" : case "opt23" : case "opt24" : case "opt25" :  
					if (nC4 == 0) { 
			...
			switch (e.getKey()) {
				...
				case "opt13" : 	//내부에서 외부로의 차단 탐지로그 & 이벤트 TOP
					...
					break;
				case "opt14" : 	//외부에서 내부로의 전체 탐지로그 & SIP TOP
					reportData.put("opt14", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 외부에서 내부로의 전체 탐지로그 & SIP TOP"));
					...
					break;
				case "opt15" : 	//외부에서 내부로의 허용 탐지로그 & SIP TOP
					reportData.put("opt15", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 외부에서 내부로의 허용 탐지로그 & SIP TOP"));
					...
					break;
				case "opt16" : 	//외부에서 내부로의 차단 탐지로그 & SIP TOP
					reportData.put("opt16", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 외부에서 내부로의 차단 탐지로그 & SIP TOP"));
					...
					break;
				case "opt17" : 	//내부에서 외부로의 전체 탐지로그 & SIP TOP
					reportData.put("opt17", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 내부에서 외부로의 전체 탐지로그 & SIP TOP"));
					...
					break;
				case "opt18" : 	//내부에서 외부로의 허용 탐지로그 & SIP TOP
					reportData.put("opt18", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 내부에서 외부로의 허용 탐지로그 & SIP TOP"));
					...
					break;
				case "opt19" : 	//내부에서 외부로의 차단 탐지로그 & SIP TOP
					reportData.put("opt19", push(contentsList, "    ", ItemNo, nC3 + nC2 + nC1, nS3++, " 내부에서 외부로의 차단 탐지로그 & SIP TOP"));
					...
					break;
				case "opt20" : 	//외부에서 내부로의 전체 탐지로그 & DIP TOP
					reportData.put("opt20", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 외부에서 내부로의 전체 탐지로그 & DIP TOP"));
					...
					break;
				case "opt21" : 	//외부에서 내부로의 허용 탐지로그 & DIP TOP
					reportData.put("opt21", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 외부에서 내부로의 허용 탐지로그 & DIP TOP"));
					...
					break;
				case "opt22" : 	//외부에서 내부로의 차단 탐지로그 & DIP TOP
					reportData.put("opt22", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 외부에서 내부로의 차단 탐지로그 & DIP TOP"));
					...
					break;
				case "opt23" : 	//내부에서 외부로의 전체 탐지로그 & DIP TOP
					reportData.put("opt23", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 내부에서 외부로의 전체 탐지로그 & DIP TOP"));
					...
					break;
				case "opt24" : 	//내부에서 외부로의 허용 탐지로그 & DIP TOP
					reportData.put("opt24", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 내부에서 외부로의 허용 탐지로그 & DIP TOP)"));
					...
					break;
				case "opt25" : 	//내부에서 외부로의 차단 탐지로그 & DIP TOP
					reportData.put("opt25", push(contentsList, "    ", ItemNo, nC4 + nC3 + nC2 + nC1, nS4++, " 내부에서 외부로의 차단 탐지로그 & DIP TOP"));
					...
					break;
				case "opt26" : 	//외부에서 내부로의 전체 탐지로그 & 서비스 TOP10
					reportData.put("opt26", push(contentsList, "    ", ItemNo, nC5 + nC4 + nC3 + nC2 + nC1, nS5++, " 외부에서 내부로의 전체 탐지로그 & 서비스 TOP10"));
					...
					break;
				case "opt27" : 	//내부에서 외부로의 전체 탐지로그 & 서비스 TOP10
					reportData.put("opt27", push(contentsList, "    ", ItemNo, nC5 + nC4 + nC3 + nC2 + nC1, nS5++, " 내부에서 외부로의 전체 탐지로그 & 서비스 TOP10"));

...
public class DpDdosDailyReport extends BaseReport {
	...
	public DpDdosDailyReport(UserInfo userInfo) {
	...
	private void All_DetectLog_Trend(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			Iterable<DBObject> dbResult = ddosDao.AllDetectLogTrend("HR", "1", assetCode, sStartDay, sEndDay);
	    	...
	    	List<String> hourDay = ddosDao.getPeriodHour(sStartDay, 0);
			...
			dbResult = ddosDao.AllDetectLogTrend("HR", "", assetCode, sStartDay, sEndDay);
			...
			Iterable<DBObject> dbResult = ddosDao.AllDetectLogTrend("DY", "1", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
			...
			dbResult = ddosDao.AllDetectLogTrend("DY", "", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay);
	...
	private void All_DetectGroup_Trend(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("HR", assetCode, sStartDay, sEndDay, true, "count");
	    	...
	    	for (DBObject val : dbResult) {
	    		...
	    		String sHour = ((Integer)val.get("hour")).toString();
	    		sHour = sHour.length() == 1 ? "0" + sHour : sHour;
	    		mapResult.put(sGroup + "-" + sYear + sMonth + sDay + sHour, val);
			...
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("DY", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay, true, "count");
	...
	private void All_DetectAttack_Trend(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, int nChoice) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("HR", assetCode, sStartDay, sEndDay, false, "pktCnt");
			...
			dbResult = ddosDao.AllDetectAttackTrend("HR", assetCode, sStartDay, sEndDay, false, "bandwidth");
			...
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("DY", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay, false, "pktCnt");
			...
			dbResult = ddosDao.AllDetectAttackTrend("DY", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay, false, "bandwidth");
	...
	private void Group_DetectAttack_Trend(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, int nChoice, String sSortField) throws Exception {
		...
		if (nChoice == 1) {	//해당일
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("HR", assetCode, sStartDay, sEndDay, true, sSortField);
			...
			Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("DY", assetCode, ddosDao.addDate(sStartDay,-2), sEndDay, true, sSortField);
	...
	private void Compare_DetectAttack_Trend(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, String sSortField) throws Exception {
		...
		Iterable<DBObject> dbResult = ddosDao.AllDetectAttackTrend("HR", assetCode, ddosDao.addDate(sStartDay, -1), sEndDay, false, sSortField);
    	...
    	List<String> hourDay = ddosDao.getPeriodHour(sStartDay, -1);
	...
	private void Attact_GroupTopN(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay) throws Exception {
    	...
    	Iterable<DBObject> dbBefore = ddosDao.GroupTopN("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), false, "");
	...
	private void All_EventTopN(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, String sSortField, int nLimit) throws Exception {
    	...
    	Iterable<DBObject> dbBefore = ddosDao.EventTopN("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), true, "", sSortField);
    	HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>(); 
    	for (DBObject val : dbBefore) {
	...
	private void New_DetectLog_Condition(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay) throws Exception {
    	...
    	//신규 탐지 이벤트리스트
    	Iterable<DBObject> dbNewResult = ddosDao.EventTopN("DY", assetCode, sStartDay, sEndDay, true, "", "count");
		...
		//전일 탐지 이벤트리스트
    	Iterable<DBObject> dbResult = ddosDao.EventTopN("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), true, "", "count");
    	for (DBObject val : dbResult) {
		...
		for (DBObject mVal : newList) {
	    	...
	    	dbResult = ddosDao.EventTopNTrend("HR", sAction, assetCode, sStartDay, sEndDay, sMessage);
	    	HashMap<String, DBObject> mapResult = new HashMap<String, DBObject>(); 
    	...
    	for (DBObject mVal : newList) {
			...
			Iterable<DBObject> srcIpTop5 = ddosDao.EventSrcIpTopN("DY", assetCode, sStartDay, sEndDay, sAction, sMessage, "count", 5);
			for (DBObject sVal : srcIpTop5) {
				HashMap<String, Object> map = new HashMap<String, Object>();
				map.put("no", nNo);
				map.put("message", sMessage);
	...
	private void Double_DetectLog_Condition(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay) throws Exception {
		...
		//전일 탐지 이벤트리스트
		Iterable<DBObject> dbBefore = ddosDao.EventTopN("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), true, "", "count");
		HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>();
    	for (DBObject val : dbBefore) {
    		mapBefore.put((String)val.get("action") + "-" + (String)val.get("message"), val);
    	}
    	...
    	Iterable<DBObject> dbResult = ddosDao.EventTopN("DY", assetCode, sStartDay, sEndDay, true, "", "count");
    	for (DBObject val : dbResult) {
    		String sMessage = (String)val.get("message");
    		String sAction = (String)val.get("action");
	...
	private void DetectLog_IpTopN(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, boolean bSrcIp, String sSortField, int nLimit, boolean bChk) throws Exception {
    	...
    	//전일 현황
    	Iterable<DBObject> dbBefore = ddosDao.BeforeIpCondition("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), bSrcIp, sSortField, topNIps);
    	HashMap<String, DBObject> mapBefore = new HashMap<String, DBObject>();
    	for (DBObject val : dbBefore) {
    		if (bSrcIp) {
    	...
    	if (bSrcIp) {
	    	...
	    	if (bChk) { //SRC IP TOP10 세션 로그 발생추이 
	        	...
	        	Iterable<DBObject> ipTopNTrend = ddosDao.IpTopNTrend("HR", assetCode, sStartDay, sEndDay, topNIps, true, sSortField);
	...
	private void DetectLog_ServiceTopN(HashMap<String, Object> reportData, int assetCode, String sStartDay, String sEndDay, String sSortField) throws Exception {
    	...
    	//전일 현황
    	Iterable<DBObject> dbBefore = ddosDao.BeforeServiceCondition("DY", assetCode, ddosDao.addDate(sStartDay,-1), ddosDao.addDate(sEndDay,-1), sSortField, topNService);

...
<div class="mb10">
  <input type="checkbox" id="opt06" name="opt06"><label for="opt06"> 외부에서 내부로의 전체 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt07" name="opt07"><label for="opt07"> 내부에서 외부로의 전체 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt08" name="opt08"><label for="opt08"> 외부에서 내부로의 전체 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt09" name="opt09"><label for="opt09"> 내부에서 외부로의 전체 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">

...
<div class="mb10">
  <input type="checkbox" id="opt01" name="opt01"><label for="opt01"> 전체 세션로그 발생추이</label>
...
<div class="mb10">
  <input type="checkbox" id="opt04" name="opt04"><label for="opt04"> 외부에서 내부로의 전체 세션 로그 발생추이</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt07" name="opt07"><label for="opt07"> 내부에서 외부로의 전체 세션 로그 발생추이</label>
  <div style="margin-left: 20px;" class="subpanel">

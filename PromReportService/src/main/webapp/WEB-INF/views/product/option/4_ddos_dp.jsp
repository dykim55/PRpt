...
<div class="mb10">
  <input type="checkbox" id="opt6" name="opt6"><label for="opt6"> 전체 탐지로그 & 공격 유형별 TOP#10 (차트, 표)</label>
</div>

<div class="mb10">
  <input type="checkbox" id="opt7" name="opt7"><label for="opt7"> 전체 탐지로그 & 이벤트 TOP - 로그건 (차트, 표)</label>
...
<div class="mb10">
  <input type="checkbox" id="opt8" name="opt8"><label for="opt8"> 전체 탐지로그 & 이벤트 TOP - Drop Packet Cnt (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt9" name="opt9"><label for="opt9"> 전체 탐지로그 & 이벤트 TOP - Bandwidth (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">

...
<div class="mb10">
  ...
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <div style="margin-left: 20px;" class="subpanel">
        <input type="radio" name="sd4" id="sd4-1" value="1" checked><label for="sd4-1"> 최근 1개월 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="sd4" id="sd4-2" value="2"><label for="sd4-2"> 최근 6개월 (차트)</label>&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
  </div>
</div>

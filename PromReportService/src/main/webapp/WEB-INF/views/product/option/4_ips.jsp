...
<div class="mb10">
  <input type="checkbox" id="opt5" name="opt5"><label for="opt5"> 외부에서 내부로의 허용 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt6" name="opt6"><label for="opt6"> 외부에서 내부로의 차단 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt7" name="opt7"><label for="opt7"> 내부에서 외부로의 전체 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt8" name="opt8"><label for="opt8"> 내부에서 외부로의 허용 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt9" name="opt9"><label for="opt9"> 내부에서 외부로의 차단 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">

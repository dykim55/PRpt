...
<div class="mb10">
  <input type="checkbox" id="opt03" name="opt03"><label for="opt03"> 내부에서 외부로의 전체 탐지로그 발생추이 (차트)</label>
</div>

<h2 class="mb10">이벤트 TOP#N</h2>
<div class="mb10">
  <input type="checkbox" id="opt04" name="opt04"><label for="opt04"> 외부에서 내부로의 전체 탐지로그 & 이벤트 TOP (차트, 표)</label>
...
<div class="mb10">
  <input type="checkbox" id="opt05" name="opt05"><label for="opt05"> 외부에서 내부로의 허용 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt06" name="opt06"><label for="opt06"> 외부에서 내부로의 차단 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="checkbox" id="ck6" name="ck6"><label for="ck6"> 이벤트 TOP10 발생추이 (차트)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt07" name="opt07"><label for="opt07"> 내부에서 외부로의 전체 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt08" name="opt08"><label for="opt08"> 내부에서 외부로의 허용 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="radio" name="rd8" id="rd8-3" value="30"><label for="rd8-3"> TOP 30</label></br>
    <input type="checkbox" id="ck8" name="ck8"><label for="ck8"> 이벤트 TOP10 발생추이 (차트)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt09" name="opt09"><label for="opt09"> 내부에서 외부로의 차단 탐지로그 & 이벤트 TOP (차트, 표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt10" name="opt10"><label for="opt10"> 외부에서 내부로의 전체 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt11" name="opt11"><label for="opt11"> 외부에서 내부로의 허용 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="checkbox" id="ck11" name="ck11"><label for="ck11"> 출발지IP TOP10 탐지로그 발생추이 (차트)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt12" name="opt12"><label for="opt12"> 외부에서 내부로의 차단 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    ...
    <input type="checkbox" id="ck12" name="ck12"><label for="ck12"> 출발지IP TOP10 탐지로그 발생추이 (차트)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt13" name="opt13"><label for="opt13"> 내부에서 외부로의 전체 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="radio" name="rd13" id="rd13-1" value="10" checked><label for="rd13-1"> TOP 10</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd13" id="rd13-2" value="13"><label for="rd13-2"> TOP 13</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="rd13" id="rd13-3" value="30"><label for="rd13-3"> TOP 30</label></br>
    <input type="checkbox" id="ck13" name="ck13"><label for="ck13"> 출발지IP TOP10 탐지로그 발생추이 (차트)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt14" name="opt14"><label for="opt14"> 내부에서 외부로의 허용 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt15" name="opt15"><label for="opt15"> 내부에서 외부로의 차단 탐지로그 & SIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt16" name="opt16"><label for="opt16"> 외부에서 내부로의 전체 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt17" name="opt17"><label for="opt17"> 외부에서 내부로의 허용 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt18" name="opt18"><label for="opt18"> 외부에서 내부로의 차단 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt19" name="opt19"><label for="opt19"> 내부에서 외부로의 전체 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt20" name="opt20"><label for="opt20"> 내부에서 외부로의 허용 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt21" name="opt21"><label for="opt21"> 내부에서 외부로의 차단 탐지로그 & DIP TOP (표)</label>
  <div style="margin-left: 20px;" class="subpanel">
...
<div class="mb10">
  <input type="checkbox" id="opt22" name="opt22"><label for="opt22"> 외부에서 내부로의 전체 탐지로그 & 서비스 TOP10 (차트)</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="checkbox" id="ck22" name="ck22"><label for="ck22"> 서비스 TOP10 증감현황 및 이벤트유형 (표)</label>
  </div>
</div>

<div class="mb10">
  <input type="checkbox" id="opt23" name="opt23"><label for="opt23"> 내부에서 외부로의 전체 탐지로그 & 서비스 TOP10 (차트)</label>
  <div style="margin-left: 20px;" class="subpanel">
    <input type="checkbox" id="ck23" name="ck23"><label for="ck23"> 서비스 TOP10 증감현황 및 이벤트유형 (표)</label>
  </div>
</div>
